...
{#if selectMode && selectedCount > 0}
  <div class="act-bar" role="region" aria-label="Bulk actions">
...
<style>
  ...
  /* Bulk action bar + buttons now come from the shared .act-bar / .act-btn
     system in app.css (form-factor aware: restrained on desktop, solid and
