...
//
// Security model:
//   - RLS policies (Migration 011) allow the anon role to read public data:
//       users where is_public = true
//       collections of those users
//       records where is_public_record = true
//       record_collections junctions for those records
//   - Application layer enforces the same filters explicitly (defense in depth)
...
//
// Caching:
//   - In-memory Map, 5-minute TTL
//   - Cache key: username normalized to lowercase
// ─────────────────────────────────────────────────────────────────────────
