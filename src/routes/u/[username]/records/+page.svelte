...
<svelte:head>
  <title>All records · {user.display_name || user.username} · Hyllah</title>
  <meta name="description" content="{user.display_name || user.username} — {records.length} public records" />
</svelte:head>
...
<div class="public-records">
  ...
  <nav class="breadcrumb">
    ...
    <span class="sep">·</span>
    <span class="crumb current">All records</span>
  </nav>
...
<style>
  ...
  @media (max-width: 640px) {
    .public-records { padding: 24px 20px 60px; }
    .records-grid {
